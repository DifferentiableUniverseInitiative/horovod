...
Communicator Request::communicator() const {return communicator_; };
...
void Request::set_communicator(const Communicator communicator){ communicator_ = communicator; };
...
void Request_ParseFromWire(Request& request,
  ...
  request.set_communicator((Communicator) obj->communicator());
}
...
void Request_SerializeToWire(const Request& request,
  ...
  request_builder.add_communicator((wire::Communicator) request.communicator());
