...
enum Communicator {
  Communicator_GLOBAL = 0,
  Communicator_LOCAL = 1,
  Communicator_CROSS = 2,
  Communicator_MIN = Communicator_GLOBAL,
  Communicator_MAX = Communicator_CROSS
};

inline const Communicator (&EnumValuesCommunicator())[3] {
  static const Communicator values[] = {
    Communicator_GLOBAL,
    Communicator_LOCAL,
    Communicator_CROSS
  };
...
inline const char * const *EnumNamesCommunicator() {
  static const char * const names[] = {
    "GLOBAL",
    "LOCAL",
    "CROSS",
...
inline const char *EnumNameCommunicator(Communicator e) {
  if (e < Communicator_GLOBAL || e > Communicator_CROSS) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesCommunicator()[index];
}
...
struct Request FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  Communicator communicator() const {
    return static_cast<Communicator>(GetField<int8_t>(VT_COMMUNICATOR, 0));
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int8_t>(verifier, VT_COMMUNICATOR) &&
           verifier.EndTable();
  }
};
...
struct RequestBuilder {
  ...
  void add_communicator(Communicator communicator) {
    fbb_.AddElement<int8_t>(Request::VT_COMMUNICATOR, static_cast<int8_t>(communicator), 0);
  }
...
inline flatbuffers::Offset<Request> CreateRequest(
    ...
    Communicator communicator = Communicator_GLOBAL) {
  ...
  builder_.add_communicator(communicator);
...
struct ResponseBuilder {
  ...
  void add_communicator(Communicator communicator) {
    fbb_.AddElement<int8_t>(Response::VT_COMMUNICATOR, static_cast<int8_t>(communicator), 0);
  }
